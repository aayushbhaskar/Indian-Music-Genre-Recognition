#Classification Using KNN, 3 neighbours
...
from fft_generator import fead_fftx, plot_confusion_matrix

genre_list=GENRE_LIST


def train_model_knn(X, Y, name, plot=False):
    """
...
if __name__ == "__main__":
    ...
    train_avg, test_avg, cms = train_model_knn(X, y, "fftx", plot=True)
